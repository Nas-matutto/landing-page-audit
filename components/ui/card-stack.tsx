  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-40 w-[76%] rounded-full bg-black/8 blur-3xl"
          aria-hidden="true"
        />
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "w-6 bg-primary" : "w-2 bg-slate-300 hover:bg-slate-400",
                  )}
