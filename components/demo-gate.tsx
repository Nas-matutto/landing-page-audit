              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {currentQuestion.options.map(option => (
                  <button
                    ...
                    className="group w-full text-left rounded-2xl border border-slate-200 bg-white px-6 py-5 text-base font-medium text-slate-700 hover:border-primary hover:bg-primary/5 hover:text-primary transition-all shadow-sm hover:shadow-md"
                  >
          ...
          {step === QUESTIONS.length && (
            <div key="email" className="animate-in fade-in slide-in-from-bottom-3 duration-300">
              ...
              <p className="text-slate-400 text-center text-sm mb-10">
                Your email unlocks the video. No spam — ever.
              </p>
