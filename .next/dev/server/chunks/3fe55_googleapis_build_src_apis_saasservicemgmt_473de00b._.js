module.exports = [
"[project]/node_modules/.pnpm/googleapis@173.0.0/node_modules/googleapis/build/src/apis/saasservicemgmt/v1.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/.pnpm/googleapis@173.0.0/node_modules/googleapis/build/src/apis/saasservicemgmt/v1beta1.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
(function(saasservicemgmt_v1beta1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context){
            this.context = context;
            this.flagAttributes = new Resource$Projects$Locations$Flagattributes(this.context);
            this.flagReleases = new Resource$Projects$Locations$Flagreleases(this.context);
            this.flagRevisions = new Resource$Projects$Locations$Flagrevisions(this.context);
    ...
    class Resource$Projects$Locations$Flagattributes {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/flagAttributes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Flagattributes = Resource$Projects$Locations$Flagattributes;
    class Resource$Projects$Locations$Flagreleases {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/flagReleases').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Flagreleases = Resource$Projects$Locations$Flagreleases;
    class Resource$Projects$Locations$Flagrevisions {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/flagRevisions').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Flagrevisions = Resource$Projects$Locations$Flagrevisions;
    class Resource$Projects$Locations$Flags {
        context;
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/flags').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Flags = Resource$Projects$Locations$Flags;
    class Resource$Projects$Locations$Releases {
        context;
        constructor(context){
            this.context = context;
...
"[project]/node_modules/.pnpm/googleapis@173.0.0/node_modules/googleapis/build/src/apis/saasservicemgmt/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const v1_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/googleapis@173.0.0/node_modules/googleapis/build/src/apis/saasservicemgmt/v1.js [app-route] (ecmascript)");
Object.defineProperty(exports, "saasservicemgmt_v1", {
    enumerable: true,
    get: function() {
        return v1_1.saasservicemgmt_v1;
    }
});
const v1beta1_1 = __turbopack_context__.r("[project]/node_modules/.pnpm/googleapis@173.0.0/node_modules/googleapis/build/src/apis/saasservicemgmt/v1beta1.js [app-route] (ecmascript)");
Object.defineProperty(exports, "saasservicemgmt_v1beta1", {
    enumerable: true,
    get: function() {
        return v1beta1_1.saasservicemgmt_v1beta1;
    }
});
exports.VERSIONS = {
...
function saasservicemgmt(versionOrOptions) {
    return (0, googleapis_common_1.getAPI)('saasservicemgmt', versionOrOptions, exports.VERSIONS, this);
}
...
//# sourceMappingURL=3fe55_googleapis_build_src_apis_saasservicemgmt_473de00b._.js.map