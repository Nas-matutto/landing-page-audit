...
const metadata = {
    ...
    description: "Get fast, actionable AI landing-page audits that help startups convert more. Know exactly why visitors aren't converting and what to fix today.",
    generator: "v0.app",
    icons: {
        icon: [
            {
